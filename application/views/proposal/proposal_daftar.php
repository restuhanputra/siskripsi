				...
				<form class="form" enctype="multipart/form-data" action="" method="post">
					<div class="box-body">
						...
						<div class="form-group row <?= form_error('judul_proposal') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<textarea class="form-control" rows="5" name="judul_proposal" placeholder="Judul Proposal Skripsi"></textarea>
			...
			<div class="box" style="border-radius: none; border-top: none;">
				...
				<div class="box-body">
					<ol style="padding-inline-start: 20px !important;">
						...
						<li>Ukuran (<i>size</i>) file Proposal Skripsi maximal 10 MB.</li>
					</ol>
				</div> <!-- /.box-body -->
			</div> <!-- /.box -->
