				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="<?= site_url('proposal') ?>">PROPOSAL SKRIPSI</a></li>
							<li><a href="<?= site_url('sdg_proposal') ?>">SIDANG PROPOSAL SKRIPSI</a></li>
							<li><a href="<?= site_url('sdg_skripsi') ?>">SIDANG SKRIPSI</a></li>
							<li><a href="<?= site_url('wisuda') ?>">WISUDA</a></li>
							<li class="divider"></li>
