				...
				<div class='box-header with-border'>
					...
					<h3 class='box-title pull-right'>
						<form action="<?= site_url('wisuda/detail') ?>" method="post">
							<input type="hidden" name="wisuda_id" value="<?= $g_wisuda_id['wisuda_id'] ?>">
				...
				<form class="form" enctype="multipart/form-data" action="" method="post">
					<div class="box-body">
						...
						<div class="form-group row <?= form_error('nama_lkp') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="nama_lkp" placeholder="Nama Lengkap" value="<?= $g_wisuda_id['nama_lkp'] ?>" readonly>
								<?= form_error('nama_lkp') ?>
							</div>
						</div>
						<div class="form-group row <?= form_error('npm') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" name="npm" placeholder="NPM" value="<?= $g_wisuda_id['npm'] ?>" readonly>
								<?= form_error('npm') ?>
							</div>
						</div>
						<div class="form-group row <?= form_error('prodi') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="prodi" placeholder="Program Studi" value="<?= $g_wisuda_id['prodi_nama'] ?>" readonly>
								<?= form_error('prodi') ?>

								<input type="hidden" name="prodi_id" value="<?= $g_wisuda_id['prodi_id'] ?>">
							</div>
						</div>
						<div class="form-group row <?= form_error('nik') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" name="nik" placeholder="Nomor Induk Kependudukan" value="<?= $g_wisuda_id['nik'] ?>">
								<?= form_error('nik') ?>
							</div>
						</div>
						<div class="form-group row <?= form_error('sma_smk') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="sma_smk" placeholder="Asal SMA/SMK" value="<?= $g_wisuda_id['sma_smk'] ?>">
								<?= form_error('sma_smk') ?>
							</div>
						</div>
						<div class="form-group row <?= form_error('lulus_sma_smk') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" name="lulus_sma_smk" placeholder="Tahun Lulus SMA/SMK" value="<?= $g_wisuda_id['lulus_sma_smk'] ?>">
						...
						<div class="form-group row <?= form_error('tgl_lahir') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control pull-right" name="tgl_lahir" placeholder="Tanggal Lahir" id="datepicker" value="<?= $g_wisuda_id['tanggal_lahir'] ?>">
						...
						<div class="form-group row <?= form_error('alamat') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<textarea class="form-control" rows="5" name="alamat" placeholder="Alamat Lengkap"><?= $g_wisuda_id['alamat_lkp'] ?></textarea>
								<?= form_error('alamat') ?>
							</div>
						</div>
						<div class="form-group row <?= form_error('no_telp') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" name="no_telp" placeholder="No. Telp" value="<?= $g_wisuda_id['no_telp'] ?>">
								<?= form_error('no_telp') ?>
							</div>
						</div>
						<div class="form-group row <?= form_error('email') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="email" class="form-control" name="email" placeholder="E-mail" value="<?= $g_wisuda_id['email'] ?>">
								<?= form_error('email') ?>
							</div>
						</div>
						<div class="form-group row <?= form_error('nama_ayah') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="nama_ayah" placeholder="Nama Ayah" value="<?= $g_wisuda_id['nama_ayah'] ?>">
						...
						<div class="form-group row <?= form_error('nama_ibu') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="nama_ibu" placeholder="Nama Ibu" value="<?= $g_wisuda_id['nama_ibu'] ?>">
								<?= form_error('nama_ibu') ?>
							</div>
						</div>
						<div class="form-group row <?= form_error('tanggal_sdg') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="tanggal_sdg" placeholder="Tanggal Sidang" value="<?= $g_wisuda_id['tanggal_sdg'] ?>" readonly>
						...
						<div class="form-group row <?= form_error('judul_skripsi_ina') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<textarea class="form-control" rows="5" name="judul_skripsi_ina" placeholder="Judul Skripsi (B. Indonesia)"><?= $g_wisuda_id['judul_skripsi_ina'] ?></textarea>
						...
						<div class="form-group row <?= form_error('judul_skripsi_eng') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<textarea class="form-control" rows="5" name="judul_skripsi_eng" placeholder="Judul Skripsi (B. Inggris)"><?= $g_wisuda_id['judul_skripsi_eng'] ?></textarea>
