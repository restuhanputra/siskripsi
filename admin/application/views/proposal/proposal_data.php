		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class='box-header with-border'>
					<h3 class='box-title'>
						<form action="<?= site_url('proposal/laporan') ?>" method="post" target="_blank">
							...
							<tbody>
								...
								?>
										...
										<tr>
											...
											<td class="text-center">
												...
												?>
													<form action="<?= site_url('proposal/revisi') ?>" method="post">
														...
														<button onclick="return confirm('Revisi Data, Apakah anda yakin ?')" href="<?= site_url('proposal/revisi') ?>" class="btn btn-sm btn-flat btn-warning"><i class="fa fa-edit"></i></button>
													</form>
												<?php
												} else {
												?>
											...
											<td class="text-center">
												<form action="<?= site_url('proposal/delete') ?>" method="post">
													<input type="hidden" name="proposal_id" value="<?= $proposal_id ?>">
													<input type="hidden" name="tahun_akademik_id" value="<?= $g_tahun_akademik_id ?>">
