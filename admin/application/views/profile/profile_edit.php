				...
				<div class="box-body">
					<form class="form" action="<?= site_url('profile/edit') ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group row <?= form_error('nama_lkp') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="nama_lkp" placeholder="Nama Legkap" value="<?= $user_id['nama_lkp'] ?>" readonly>
								<?= form_error('nama_lkp') ?>
							</div>
						</div>
						<div class="form-group row <?= form_error('agama') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="agama" placeholder="Agama" value="<?= $user_id['agama_nama'] ?>" readonly>
								<?= form_error('agama') ?>
							</div>
						</div>
