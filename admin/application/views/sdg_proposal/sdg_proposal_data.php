		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class='box-header with-border'>
					<h3 class='box-title'>
						<form action="<?= site_url('sdg_proposal/laporan') ?>" method="post" target="_blank">
							...
							<tbody>
								...
								?>
										...
										<tr>
											...
											<td class="text-center">
												...
												?>
													<form action="<?= site_url('sdg_proposal/revisi') ?>" method="post">
														...
														<button onclick="return confirm('Revisi Data, Apakah anda yakin ?')" href="<?= site_url('sdg_proposal/revisi') ?>" class="btn btn-sm btn-flat btn-warning"><i class="fa fa-edit"></i></button>
													</form>
												<?php
												} else {
												?>
											...
											<td class="text-center">
												<form action="<?= site_url('sdg_proposal/status') ?>" method="post">
													<input type="hidden" name="sdg_proposal_id" value="<?= $sdg_proposal_id ?>">
													...
													?>
														<button class="btn btn-sm btn-flat btn-danger"><b>TIDAK LAYAK</b></button>
													<?php
													} elseif ($status == 2) {
													?>
														<button class="btn btn-sm btn-flat btn-success"><b>LAYAK</b></button>
													<?php
													}
													?>
												</form>
											...
											<td class="text-center">
												<form action="<?= site_url('sdg_proposal/delete') ?>" method="post">
													<input type="hidden" name="sdg_proposal_id" value="<?= $sdg_proposal_id ?>">

													<button onclick="return confirm('Delete data, Apakah anda yakin ?')" href="<?= site_url('sdg_proposal/delete') ?>" class="btn btn-sm btn-flat btn-danger"> <i class="fa fa-trash"></i></button>
												</form>
											</td>
										</tr>
										<!-- /. Isi Tabel -->
