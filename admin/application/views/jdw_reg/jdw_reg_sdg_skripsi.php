		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class='box-header with-border'>
					<h3 class='box-title'>
						<a href="<?= site_url('jadwal_reg/add_sdg_skripsi') ?>" class="btn btn-sm btn-flat btn-primary"><i class='fa fa-plus'></i> Tambah Data</a>
					</h3>
				...
				<div class="box-body">
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover" id="mytable">
							...
							<tbody>
								<?php
								if (!empty($g_jdw_reg_sdg_skripsi)) {
									$no = 1;
									foreach ($g_jdw_reg_sdg_skripsi as $data) :
										$jdw_sdg_skripsi_id = $data['jdw_sdg_skripsi_id'];
								...
								?>
										...
										<tr>
											...
											<td class="text-center">
												<form action="<?= site_url('jadwal_reg/edit_sdg_skripsi') ?>" method="post">
													<input type="hidden" name="jdw_sdg_skripsi_id" value="<?= $jdw_sdg_skripsi_id ?>">

													<button class="btn btn-sm btn-flat btn-primary"><i class="fa fa-edit"></i></button>
												</form>
											</td>
											<td class="text-center">
												<form action="<?= site_url('jadwal_reg/delete_sdg_skripsi') ?>" method="post">
													<input type="hidden" name="jdw_sdg_skripsi_id" value="<?= $jdw_sdg_skripsi_id ?>">
