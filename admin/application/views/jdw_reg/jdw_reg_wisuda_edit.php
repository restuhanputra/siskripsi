			...
			<div class="box">
				...
				<div class='box-header with-border'>
					<h3 class='box-title pull-right'>
						<a href="<?= site_url('jadwal_reg/wisuda') ?>" class="btn btn-sm btn-flat btn-warning"><i class='fa fa-undo'></i> Kembali</a>
					</h3>
				</div><!-- /.box-header -->
				...
				<form class="form" enctype="multipart/form-data" action="" method="post">
					<div class="box-body">
						...
						<input type="hidden" name="jdw_wisuda_id" value="<?= $g_jdw_wisuda_id['jdw_wisuda_id'] ?>">

						<div class="form-group row <?= form_error('start_date') ? 'has-error' : null ?>">
							<label for="start_date" class="col-sm-3 control-label">Start Date *</label>

							<div class="col-sm-9">
								<input type="text" class="form-control" name="start_date" placeholder="Start Date" id="datepicker1" value="<?= $g_jdw_wisuda_id['start_date'] ?>" autocomplete="off">
						...
						<div class="form-group row <?= form_error('hari') ? 'has-error' : null ?>">
							...
							<div class="col-sm-9">
								<input type="number" class="form-control" name="hari" placeholder="Hari (Masa Berlaku)" autocomplete="off" value="<?= $g_jdw_wisuda_id['hari'] ?>">
						...
						<div class="form-group row <?= form_error('aktifkah') ? 'has-error' : null ?>">
							...
							<div class="col-sm-9">
								<select class="form-control" name="aktifkah">
									<?php if ($g_jdw_wisuda_id['aktifkah'] == 2) {
