				...
				<form class="form" enctype="multipart/form-data" action="" method="post">
					<div class="box-body">
						...
						<div class="form-group row <?= form_error('start_date') ? 'has-error' : null ?>">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="start_date" placeholder="Start Date" id="datepicker1" autocomplete="off">
						...
						<div class="form-group row <?= form_error('hari') ? 'has-error' : null ?>">
							...
							<div class="col-sm-9">
								<input type="number" class="form-control" name="hari" placeholder="Hari (Masa Berlaku)" autocomplete="off">
