			...
			<div class="box" style="border-radius: none; border-top: none;">
				...
				<div class="box-body">
					<form class="form" enctype="multipart/form-data" action="" method="post">
						...
						<?php
						$smt = $g_sdg_ppsal_id['semester'] == 1 ? "GANJIL" : "GENAP"  ?>
						<div class="form-group row <?= form_error('semester') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="semester" placeholder="Semester" value="<?= $g_sdg_ppsal_id['tahun'] . ' ' . $smt ?>" readonly>
								<?= form_error('semester') ?>
							</div>
						</div>
						...
						<div class="form-group row <?= form_error('npm') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="npm" placeholder="NPM" value="<?= $g_sdg_ppsal_id['npm'] ?>" readonly>
								<?= form_error('npm') ?>
							</div>
						</div>
						...
						<div class="form-group row <?= form_error('nama_lkp') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="nama_lkp" id="nama_lkp" placeholder="Nama Lengkap" value="<?= $g_sdg_ppsal_id['nama_lkp'] ?>" readonly>
								<?= form_error('nama_lkp') ?>
							</div>
						</div>
						...
						<div class="form-group row <?= form_error('judul_proposal') ? 'has-error' : null ?>">
							...
							<div class="col-sm-8">
								<textarea class="form-control" rows="5" name="judul_proposal" id="judul_proposal" placeholder="Judul Proposal" readonly><?= $g_sdg_ppsal_id['judul_proposal'] ?></textarea>
