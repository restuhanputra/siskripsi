		...
		<div class="col-sm-8">
			...
			<div class="box" style="border-radius: none; border-top: none;">
				<div class="box-body box-profile">
					...
					<h3 class="profile-username text-center"><?= $dsn_id['nama_lkp'] ?></h3>
			...
			<div class="box" style="border-radius: none; border-top: none;">
				...
				<div class="box-body">
					<div class="news-item-detail">
						<p class="news-item-preview"> <i class="fa fa-lock color-primary"></i> &nbsp;Gunakan sandi yang unik dan kuat </p>
					</div>
					<div class="news-item-detail">
